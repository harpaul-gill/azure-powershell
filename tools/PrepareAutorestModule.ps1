...
$SKIP_MODULES = @("Aks", "AppService", "Billing", "Compute", "ContainerInstance", "ContainerRegistry", "Dns", "DnsResolver", "KeyVault", "Media", "Monitor", "Network", "Resources", "ServiceBus", "Storage")
